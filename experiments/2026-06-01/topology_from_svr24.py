#!/usr/bin/env python3
"""Toy topology predictor: 24 OCC gray images -> face adjacency matrix.
...
def run_eval_or_predict(args):
    ...
    out_base = Path(args.output_dir) / f"{args.model_id}_svr24_topology"
    np.savez_compressed(
...
def main():
    ...
    parser.add_argument("--output-dir", default="experiments/2026-06-01/outputs_svr24")
