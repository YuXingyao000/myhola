...
|------|----------|------|-----------|
| Topology VAE decoder | 06-08 corruption-only | test `ar_f1=0.9479`、`exact=0.7826` | [best.pt](/mnt/d/data) <!-- 替换为真实 checkpoint 路径 --> |
...
- [ ] 冻结 06-08 topology decoder，仅训练 image-conditioned prior / adapter（直接回答开放问题 1）。
