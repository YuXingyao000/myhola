...
PREFIX_MAP = (
    ...
    ("cad_align_proj.", "denoiser.condition_fuser.cad_alignment_projection."),
    ("img_align_proj.", "denoiser.condition_fuser.condition_alignment_projection."),
    ("cad_align_head.", "denoiser.condition_fuser.cad_alignment_head."),
    ("img_align_head.", "denoiser.condition_fuser.condition_alignment_head."),
