...
Exported classes:
    - AutoEncoder_1119                   (main/full VAE)
    - AutoEncoder_1119_TokenVAE          (token-based encoder+decoder variant)
    - AutoEncoder_1119_TokenEncConvDecVAE (token encoder + conv decoder hybrid)
    - AutoEncoder_1119_light             (lighter variant, fewer layers)
    - AutoEncoder_1225                   (alternative architecture)
"""
...
from src.brepnet.models.blocks import (
    ResBlockXD, ResLinear, ResBlock1D, ResBlock2D,
    FourierPE, make_uv_grid, make_t_grid,
    CrossAttnBlock, SelfAttnBlock,
    SurfaceTokenEncoder, CurveTokenEncoder,
    SurfaceQueryDecoder, CurveQueryDecoder,
    AttnIntersection,
    inv_sigmoid,
)

# Backward-compatible aliases used inside network definitions
