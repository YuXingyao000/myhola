...
os.environ.setdefault("HTTP_PROXY", "http://172.31.178.116:7897")
os.environ.setdefault("HTTPS_PROXY", "http://172.31.178.116:7897")
...
def main(v_cfg: DictConfig):
    ...
    trainer = Trainer(
        ...
        # max_epochs=2,
        num_sanity_val_steps=v_cfg["trainer"].get("num_sanity_val_steps", 2),
